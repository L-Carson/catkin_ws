...
"""autogenerated by genpy from comm_msg/traffic_light_result.msg. Do not edit."""
import codecs
import sys
...
class traffic_light_result(genpy.Message):
  _md5sum = "ba4a9d03d85e5a0dea143f8c7a972bb2"
  _type = "comm_msg/traffic_light_result"
...
uint8 value"""
  __slots__ = ['header','type','label','seconds','status']
  _slot_types = ['std_msgs/Header','uint8','comm_msg/label','uint8','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,type,label,seconds,status
    ...
    """
    if args or kwds:
      super(traffic_light_result, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_4B().pack(_x.type, _x.label.value, _x.seconds, _x.status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.type, _x.label.value, _x.seconds, _x.status,) = _get_struct_4B().unpack(str[start:end])
      return self
