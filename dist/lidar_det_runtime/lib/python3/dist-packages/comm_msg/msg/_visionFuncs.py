...
"""autogenerated by genpy from comm_msg/visionFuncs.msg. Do not edit."""
import codecs
import sys
...
class visionFuncs(genpy.Message):
  _md5sum = "440c01f662b2f182e9590f3a79f9ac6e"
  _type = "comm_msg/visionFuncs"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """visionFunc[]  funcs
================================================================================
...
uint8 value"""
  __slots__ = ['funcs']
  _slot_types = ['comm_msg/visionFunc[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(visionFuncs, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.funcs:
        _x = val1
        buff.write(_get_struct_3B().pack(_x.funcId, _x.ipu, _x.hz))
        length = len(val1.cameras)
        buff.write(_struct_I.pack(length))
        for val2 in val1.cameras:
          length = len(val2)
          if python3 or type(val2) == unicode:
            val2 = val2.encode('utf-8')
            length = len(val2)
          buff.write(struct.Struct('<I%ss'%length).pack(length, val2))
        length = len(val1.usingLabel)
        buff.write(_struct_I.pack(length))
        for val2 in val1.usingLabel:
          _x = val2.value
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val2 = str[start:end]
          val1.cameras.append(val2)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.usingLabel = []
        for i in range(0, length):
          val2 = comm_msg.msg.label()
          start = end
          end += 1
          (val2.value,) = _get_struct_B().unpack(str[start:end])
          val1.usingLabel.append(val2)
        self.funcs.append(val1)
      return self
