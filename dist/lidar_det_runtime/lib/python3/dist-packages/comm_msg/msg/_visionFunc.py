...
"""autogenerated by genpy from comm_msg/visionFunc.msg. Do not edit."""
import codecs
import sys
...
class visionFunc(genpy.Message):
  _md5sum = "79b818443e89e9f0f5bd6b426111152a"
  _type = "comm_msg/visionFunc"
...
uint8 value"""
  ...
  __slots__ = ['funcId','ipu','hz','cameras','usingLabel']
  _slot_types = ['uint8','bool','uint8','string[]','comm_msg/label[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       funcId,ipu,hz,cameras,usingLabel
    ...
    """
    if args or kwds:
      super(visionFunc, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.usingLabel)
      buff.write(_struct_I.pack(length))
      for val1 in self.usingLabel:
        _x = val1.value
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.usingLabel = []
      for i in range(0, length):
        val1 = comm_msg.msg.label()
        start = end
        end += 1
        (val1.value,) = _get_struct_B().unpack(str[start:end])
        self.usingLabel.append(val1)
      return self
