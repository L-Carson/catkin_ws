// Generated by gencpp from file comm_msg/box.msg
// DO NOT EDIT!


#ifndef COMM_MSG_MESSAGE_BOX_H
#define COMM_MSG_MESSAGE_BOX_H
...
struct box_
{
  ...
  typedef boost::shared_ptr< ::comm_msg::box_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::comm_msg::box_<ContainerAllocator> const> ConstPtr;

}; // struct box_

typedef ::comm_msg::box_<std::allocator<void> > box;

typedef boost::shared_ptr< ::comm_msg::box > boxPtr;
typedef boost::shared_ptr< ::comm_msg::box const> boxConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::comm_msg::box_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::comm_msg::box_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::comm_msg::box_<ContainerAllocator1> & lhs, const ::comm_msg::box_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::comm_msg::box_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::comm_msg::box_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::comm_msg::box_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::comm_msg::box_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::comm_msg::box_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::comm_msg::box_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::comm_msg::box_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct DataType< ::comm_msg::box_<ContainerAllocator> >
{
  static const char* value()
  {
    return "comm_msg/box";
...
template<class ContainerAllocator>
struct Definition< ::comm_msg::box_<ContainerAllocator> >
{
  static const char* value()
  {
    return "label   label   #unknown car motor pede\n"
"float32 x       #center x\n"
"float32 y       #center y\n"
"float32 z       #center z\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::comm_msg::box_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::comm_msg::box_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::comm_msg::box_<ContainerAllocator>& v)
  {
    s << indent << "label: ";
    s << std::endl;
