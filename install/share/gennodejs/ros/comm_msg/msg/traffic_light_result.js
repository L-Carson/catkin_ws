...
class traffic_light_result {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new traffic_light_result(null);
  ...
  static datatype() {
    ...
    return 'comm_msg/traffic_light_result';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'ba4a9d03d85e5a0dea143f8c7a972bb2';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new traffic_light_result(null);
...
module.exports = traffic_light_result;
