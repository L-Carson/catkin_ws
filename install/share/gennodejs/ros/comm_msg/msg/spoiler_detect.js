...
class spoiler_detect {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.header = null;
      this.label = null;
      this.detect_value = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('detect_value')) {
        this.detect_value = initObj.detect_value
      }
      else {
        this.detect_value = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [detect_value]
    bufferOffset = _serializer.uint8(obj.detect_value, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new spoiler_detect(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [label]
    data.label = label.deserialize(buffer, bufferOffset);
    // Deserialize message field [detect_value]
    data.detect_value = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new spoiler_detect(null);
    ...
    if (msg.detect_value !== undefined) {
      resolved.detect_value = msg.detect_value;
    }
    else {
      resolved.detect_value = 0
    }
