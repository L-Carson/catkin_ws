...
class visionArea {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.pixels.forEach((val) => {
      bufferOffset = visionPixel.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    let length = 0;
    length += 13 * object.pixels.length;
    return length + 4;
  }
