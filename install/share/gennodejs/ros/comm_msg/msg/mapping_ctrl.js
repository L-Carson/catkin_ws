...
class mapping_ctrl {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new mapping_ctrl(null);
  ...
  static messageDefinition() {
    ...
    return `
    int32 cmd #1:save map command 2:enable gnss 3:disable gnss
  ...
  static Resolve(msg) {
    ...
    const resolved = new mapping_ctrl(null);
