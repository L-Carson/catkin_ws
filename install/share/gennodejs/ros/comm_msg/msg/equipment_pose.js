...
class equipment_pose {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new equipment_pose(null);
  ...
  static messageDefinition() {
    ...
    return `
    # location status, 1 normal, 0 abnormal
    uint8   status
    float32 posX
    float32 posY
    float32 dirAngle
  ...
  static Resolve(msg) {
    ...
    const resolved = new equipment_pose(null);
