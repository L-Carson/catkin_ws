...
class hmiStatus {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('UDiscM1')) {
        this.UDiscM1 = initObj.UDiscM1
      }
      else {
        this.UDiscM1 = 0;
      }
      if (initObj.hasOwnProperty('UDiscM2')) {
        this.UDiscM2 = initObj.UDiscM2
      }
      else {
        this.UDiscM2 = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [UDiscM1]
    bufferOffset = _serializer.uint8(obj.UDiscM1, buffer, bufferOffset);
    // Serialize message field [UDiscM2]
    bufferOffset = _serializer.uint8(obj.UDiscM2, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [UDiscM1]
    data.UDiscM1 = _deserializer.uint8(buffer, bufferOffset);
    // Deserialize message field [UDiscM2]
    data.UDiscM2 = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'comm_msg/hmiStatus';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '059f2de59d34c153969dda03562bf5b8';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.UDiscM1 !== undefined) {
      resolved.UDiscM1 = msg.UDiscM1;
    }
    else {
      resolved.UDiscM1 = 0
    }

    if (msg.UDiscM2 !== undefined) {
      resolved.UDiscM2 = msg.UDiscM2;
    }
    else {
      resolved.UDiscM2 = 0
    }
