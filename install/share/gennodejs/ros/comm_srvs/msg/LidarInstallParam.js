...
class LidarInstallParam {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LidarInstallParam(null);
  ...
  static datatype() {
    ...
    return 'comm_srvs/LidarInstallParam';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '20c26dd3c3b4024c1be1a0626d71ff63';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LidarInstallParam(null);
...
module.exports = LidarInstallParam;
