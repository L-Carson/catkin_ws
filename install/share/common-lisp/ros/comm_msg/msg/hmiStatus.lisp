...
(cl:defmethod cl:initialize-instance :after ((m <hmiStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'hmiStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comm_msg-msg:<hmiStatus> is deprecated: use comm_msg-msg:hmiStatus instead.")))

(cl:ensure-generic-function 'commLinkState-val :lambda-list '(m))
(cl:defmethod commLinkState-val ((m <hmiStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:commLinkState-val is deprecated.  Use comm_msg-msg:commLinkState instead.")
  (commLinkState m))

(cl:ensure-generic-function 'buttonState-val :lambda-list '(m))
(cl:defmethod buttonState-val ((m <hmiStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:buttonState-val is deprecated.  Use comm_msg-msg:buttonState instead.")
  (buttonState m))

(cl:ensure-generic-function 'batteryState-val :lambda-list '(m))
(cl:defmethod batteryState-val ((m <hmiStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:batteryState-val is deprecated.  Use comm_msg-msg:batteryState instead.")
  (batteryState m))

(cl:ensure-generic-function 'batteryPercent-val :lambda-list '(m))
(cl:defmethod batteryPercent-val ((m <hmiStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:batteryPercent-val is deprecated.  Use comm_msg-msg:batteryPercent instead.")
  (batteryPercent m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <hmiStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:temperature-val is deprecated.  Use comm_msg-msg:temperature instead.")
  (temperature m))

(cl:ensure-generic-function 'humidity-val :lambda-list '(m))
(cl:defmethod humidity-val ((m <hmiStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:humidity-val is deprecated.  Use comm_msg-msg:humidity instead.")
  (humidity m))

(cl:ensure-generic-function 'smogAlert-val :lambda-list '(m))
(cl:defmethod smogAlert-val ((m <hmiStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:smogAlert-val is deprecated.  Use comm_msg-msg:smogAlert instead.")
  (smogAlert m))

(cl:ensure-generic-function 'pushRodPos-val :lambda-list '(m))
(cl:defmethod pushRodPos-val ((m <hmiStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:pushRodPos-val is deprecated.  Use comm_msg-msg:pushRodPos instead.")
  (pushRodPos m))

(cl:ensure-generic-function 'emergentState-val :lambda-list '(m))
(cl:defmethod emergentState-val ((m <hmiStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:emergentState-val is deprecated.  Use comm_msg-msg:emergentState instead.")
  (emergentState m))

(cl:ensure-generic-function 'zhishancmdshow-val :lambda-list '(m))
(cl:defmethod zhishancmdshow-val ((m <hmiStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:zhishancmdshow-val is deprecated.  Use comm_msg-msg:zhishancmdshow instead.")
  (zhishancmdshow m))
...
(cl:ensure-generic-function 'UDiscM1-val :lambda-list '(m))
(cl:defmethod UDiscM1-val ((m <hmiStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:UDiscM1-val is deprecated.  Use comm_msg-msg:UDiscM1 instead.")
  (UDiscM1 m))

(cl:ensure-generic-function 'UDiscM2-val :lambda-list '(m))
(cl:defmethod UDiscM2-val ((m <hmiStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:UDiscM2-val is deprecated.  Use comm_msg-msg:UDiscM2 instead.")
  (UDiscM2 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <hmiStatus>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'pos_y))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'UDiscM1)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'UDiscM2)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <hmiStatus>) istream)
  "Deserializes a message object of type '<hmiStatus>"
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'UDiscM1)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'UDiscM2)) (cl:read-byte istream))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<hmiStatus>)))
  ...
  "059f2de59d34c153969dda03562bf5b8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'hmiStatus)))
  "Returns md5sum for a message object of type 'hmiStatus"
  "059f2de59d34c153969dda03562bf5b8")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<hmiStatus>)))
  ...
  (cl:format cl:nil "#communication link state~%uint8 commLinkState~%#button state~%uint8 buttonState~%#battery info~%uint8 batteryState  # 0:normal state; 1:charge state~%uint8 batteryPercent  # left percent 5%-100%~%~%#temperature~%uint8 temperature~%#humidity~%uint8 humidity~%#smog alert~%uint8 smogAlert  #1:alert 	0:no smog~%#push rod pos~%uint8 pushRodPos~%#emergent push button~%uint8 emergentState~%#define CMD_SAVE_INIT_PARA 1~%#define CMD_SAVE_GOAL_PSTN 2 here send the pos_x pos_y~%#define CMD_SEND_GOALS 3 ~%#define CMD_SEND_CURR_PSTN 4~%#define CMD_SAVE_POS 5~%#define CMD_SEND_POS 6~%#define CMD_SET_INIT_POS 7~%#define CMD_VOICE 8~%#define CMD_CLEAR_NAVIGOALS 9~%uint8 zhishancmdshow~%#position show~%float32 pos_x~%float32 pos_y~%# UDiscM1~%uint8 UDiscM1~%uint8 UDiscM2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'hmiStatus)))
  "Returns full string definition for message of type 'hmiStatus"
  (cl:format cl:nil "#communication link state~%uint8 commLinkState~%#button state~%uint8 buttonState~%#battery info~%uint8 batteryState  # 0:normal state; 1:charge state~%uint8 batteryPercent  # left percent 5%-100%~%~%#temperature~%uint8 temperature~%#humidity~%uint8 humidity~%#smog alert~%uint8 smogAlert  #1:alert 	0:no smog~%#push rod pos~%uint8 pushRodPos~%#emergent push button~%uint8 emergentState~%#define CMD_SAVE_INIT_PARA 1~%#define CMD_SAVE_GOAL_PSTN 2 here send the pos_x pos_y~%#define CMD_SEND_GOALS 3 ~%#define CMD_SEND_CURR_PSTN 4~%#define CMD_SAVE_POS 5~%#define CMD_SEND_POS 6~%#define CMD_SET_INIT_POS 7~%#define CMD_VOICE 8~%#define CMD_CLEAR_NAVIGOALS 9~%uint8 zhishancmdshow~%#position show~%float32 pos_x~%float32 pos_y~%# UDiscM1~%uint8 UDiscM1~%uint8 UDiscM2~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <hmiStatus>))
  ...
  (cl:list 'hmiStatus
    ...
    (cl:cons ':UDiscM1 (UDiscM1 msg))
    (cl:cons ':UDiscM2 (UDiscM2 msg))
))
