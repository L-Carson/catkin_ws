...
(cl:defmethod cl:initialize-instance :after ((m <zhishancmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'zhishancmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comm_msg-msg:<zhishancmd> is deprecated: use comm_msg-msg:zhishancmd instead.")))

(cl:ensure-generic-function 'zhishanCommand-val :lambda-list '(m))
(cl:defmethod zhishanCommand-val ((m <zhishancmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:zhishanCommand-val is deprecated.  Use comm_msg-msg:zhishanCommand instead.")
  (zhishanCommand m))

(cl:ensure-generic-function 'autoCharge-val :lambda-list '(m))
(cl:defmethod autoCharge-val ((m <zhishancmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:autoCharge-val is deprecated.  Use comm_msg-msg:autoCharge instead.")
  (autoCharge m))

(cl:ensure-generic-function 'rodControl-val :lambda-list '(m))
(cl:defmethod rodControl-val ((m <zhishancmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:rodControl-val is deprecated.  Use comm_msg-msg:rodControl instead.")
  (rodControl m))

(cl:ensure-generic-function 'zhishanPara-val :lambda-list '(m))
(cl:defmethod zhishanPara-val ((m <zhishancmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:zhishanPara-val is deprecated.  Use comm_msg-msg:zhishanPara instead.")
  (zhishanPara m))

(cl:ensure-generic-function 'zhishanVoice-val :lambda-list '(m))
(cl:defmethod zhishanVoice-val ((m <zhishancmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:zhishanVoice-val is deprecated.  Use comm_msg-msg:zhishanVoice instead.")
  (zhishanVoice m))
