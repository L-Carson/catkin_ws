...
(cl:defmethod cl:initialize-instance :after ((m <imudata>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'imudata)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comm_msg-msg:<imudata> is deprecated: use comm_msg-msg:imudata instead.")))

(cl:ensure-generic-function 'Temp-val :lambda-list '(m))
(cl:defmethod Temp-val ((m <imudata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:Temp-val is deprecated.  Use comm_msg-msg:Temp instead.")
  (Temp m))

(cl:ensure-generic-function 'Ax-val :lambda-list '(m))
(cl:defmethod Ax-val ((m <imudata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:Ax-val is deprecated.  Use comm_msg-msg:Ax instead.")
  (Ax m))

(cl:ensure-generic-function 'Ay-val :lambda-list '(m))
(cl:defmethod Ay-val ((m <imudata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:Ay-val is deprecated.  Use comm_msg-msg:Ay instead.")
  (Ay m))

(cl:ensure-generic-function 'Az-val :lambda-list '(m))
(cl:defmethod Az-val ((m <imudata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:Az-val is deprecated.  Use comm_msg-msg:Az instead.")
  (Az m))

(cl:ensure-generic-function 'Gx-val :lambda-list '(m))
(cl:defmethod Gx-val ((m <imudata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:Gx-val is deprecated.  Use comm_msg-msg:Gx instead.")
  (Gx m))

(cl:ensure-generic-function 'Gy-val :lambda-list '(m))
(cl:defmethod Gy-val ((m <imudata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:Gy-val is deprecated.  Use comm_msg-msg:Gy instead.")
  (Gy m))

(cl:ensure-generic-function 'Gz-val :lambda-list '(m))
(cl:defmethod Gz-val ((m <imudata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:Gz-val is deprecated.  Use comm_msg-msg:Gz instead.")
  (Gz m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<imudata>)))
  ...
  (cl:format cl:nil "float32 Temp~%~%float32 Ax~%float32 Ay~%float32 Az~%~%float32 Gx~%float32 Gy~%float32 Gz~%float32 Yaw~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'imudata)))
  "Returns full string definition for message of type 'imudata"
  (cl:format cl:nil "float32 Temp~%~%float32 Ax~%float32 Ay~%float32 Az~%~%float32 Gx~%float32 Gy~%float32 Gz~%float32 Yaw~%~%~%~%"))
