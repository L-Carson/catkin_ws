...
(cl:defmethod cl:initialize-instance :after ((m <wheelSpeed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'wheelSpeed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comm_msg-msg:<wheelSpeed> is deprecated: use comm_msg-msg:wheelSpeed instead.")))

(cl:ensure-generic-function 'leftwheel_speed-val :lambda-list '(m))
(cl:defmethod leftwheel_speed-val ((m <wheelSpeed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:leftwheel_speed-val is deprecated.  Use comm_msg-msg:leftwheel_speed instead.")
  (leftwheel_speed m))

(cl:ensure-generic-function 'rightwheel_speed-val :lambda-list '(m))
(cl:defmethod rightwheel_speed-val ((m <wheelSpeed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:rightwheel_speed-val is deprecated.  Use comm_msg-msg:rightwheel_speed instead.")
  (rightwheel_speed m))
