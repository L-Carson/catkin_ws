...
(cl:defmethod cl:initialize-instance :after ((m <Mode>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mode)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comm_msg-msg:<Mode> is deprecated: use comm_msg-msg:Mode instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <Mode>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:mode-val is deprecated.  Use comm_msg-msg:mode instead.")
  (mode m))
