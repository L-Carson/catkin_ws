...
(cl:defmethod cl:initialize-instance :after ((m <SaveMap>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SaveMap)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comm_msg-msg:<SaveMap> is deprecated: use comm_msg-msg:SaveMap instead.")))

(cl:ensure-generic-function 'flag-val :lambda-list '(m))
(cl:defmethod flag-val ((m <SaveMap>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:flag-val is deprecated.  Use comm_msg-msg:flag instead.")
  (flag m))
