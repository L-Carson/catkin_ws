...
(cl:defmethod cl:initialize-instance :after ((m <customRoute>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'customRoute)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comm_msg-msg:<customRoute> is deprecated: use comm_msg-msg:customRoute instead.")))

(cl:ensure-generic-function 'pointIndexes-val :lambda-list '(m))
(cl:defmethod pointIndexes-val ((m <customRoute>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comm_msg-msg:pointIndexes-val is deprecated.  Use comm_msg-msg:pointIndexes instead.")
  (pointIndexes m))
