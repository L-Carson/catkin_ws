...
"""autogenerated by genpy from comm_msg/spoiler_detect.msg. Do not edit."""
import codecs
import sys
...
class spoiler_detect(genpy.Message):
  _md5sum = "03ce56ab1e5a7e206499aa32ad624a78"
  _type = "comm_msg/spoiler_detect"
...
uint8 value"""
  __slots__ = ['header','label','detect_value']
  _slot_types = ['std_msgs/Header','comm_msg/label','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(spoiler_detect, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.label is None:
        self.label = comm_msg.msg.label()
      if self.detect_value is None:
        self.detect_value = 0
    else:
      self.header = std_msgs.msg.Header()
      self.label = comm_msg.msg.label()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2B().pack(_x.label.value, _x.detect_value))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.label.value, _x.detect_value,) = _get_struct_2B().unpack(str[start:end])
      return self
