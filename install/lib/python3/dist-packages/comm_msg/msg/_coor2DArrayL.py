...
"""autogenerated by genpy from comm_msg/coor2DArrayL.msg. Do not edit."""
import codecs
import sys
...
class coor2DArrayL(genpy.Message):
  _md5sum = "729ee7f33a4f91facef2ac82db7169b5"
  _type = "comm_msg/coor2DArrayL"
...
uint8 value"""
  __slots__ = ['header','label','id','coor2DArray']
  _slot_types = ['std_msgs/Header','comm_msg/label','uint8','comm_msg/coor2D[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(coor2DArrayL, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2B().pack(_x.label.value, _x.id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.label.value, _x.id,) = _get_struct_2B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.coor2DArray = []
