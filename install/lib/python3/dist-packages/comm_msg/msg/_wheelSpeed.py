...
"""autogenerated by genpy from comm_msg/wheelSpeed.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2f().pack(_x.leftwheel_speed, _x.rightwheel_speed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.leftwheel_speed, _x.rightwheel_speed,) = _get_struct_2f().unpack(str[start:end])
      return self
