...
"""autogenerated by genpy from comm_msg/visionRect.msg. Do not edit."""
import codecs
import sys
...
class visionRect(genpy.Message):
  _md5sum = "b747118cb5066a7266881512a4bb9821"
  _type = "comm_msg/visionRect"
...
uint8 value"""
  __slots__ = ['label','score','xmin','ymin','xmax','ymax','feature']
  _slot_types = ['comm_msg/label','float32','uint32','uint32','uint32','uint32','float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       label,score,xmin,ymin,xmax,ymax,feature
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_Bf4I().pack(_x.label.value, _x.score, _x.xmin, _x.ymin, _x.xmax, _x.ymax))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.label.value, _x.score, _x.xmin, _x.ymin, _x.xmax, _x.ymax,) = _get_struct_Bf4I().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_I():
    ...
    return _struct_I
_struct_Bf4I = None
def _get_struct_Bf4I():
    global _struct_Bf4I
    if _struct_Bf4I is None:
        _struct_Bf4I = struct.Struct("<Bf4I")
    return _struct_Bf4I
