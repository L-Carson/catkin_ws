...
"""autogenerated by genpy from comm_msg/imudata.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_8f().pack(_x.Temp, _x.Ax, _x.Ay, _x.Az, _x.Gx, _x.Gy, _x.Gz, _x.Yaw))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.Temp, _x.Ax, _x.Ay, _x.Az, _x.Gx, _x.Gy, _x.Gz, _x.Yaw,) = _get_struct_8f().unpack(str[start:end])
      return self
