...
"""autogenerated by genpy from comm_msg/zhishancmd.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_5B().pack(_x.zhishanCommand, _x.autoCharge, _x.rodControl, _x.zhishanPara, _x.zhishanVoice))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.zhishanCommand, _x.autoCharge, _x.rodControl, _x.zhishanPara, _x.zhishanVoice,) = _get_struct_5B().unpack(str[start:end])
      return self
