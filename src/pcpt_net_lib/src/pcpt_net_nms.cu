...
修改记录:
**************************************************************************************/
__device__ inline int intersection(const Point &p1, const Point &p0, const Point &q1,
...
/**************************************************************************************
功能描述: rotate_around_center
修改记录:
**************************************************************************************/
__device__ inline void rotate_around_center(const Point &center, const float angle_cos,
...
/**************************************************************************************
功能描述:box_overlap  params box_a: [x, y, z, dx, dy, dz, heading]
...
/**************************************************************************************
功能描述: iou_bev  params box_a: [x, y, z, dx, dy, dz, heading]
                  params box_b: [x, y, z, dx, dy, dz, heading]
修改记录:
**************************************************************************************/
...
/**************************************************************************************
功能描述: boxes_overlap_kernel  params boxes_a: (N, 7) [x, y, z, dx, dy, dz, heading]
                               params boxes_b: (M, 7) [x, y, z, dx, dy, dz, heading]
修改记录:
**************************************************************************************/
__global__ void boxes_overlap_kernel(const int num_a, const float *boxes_a, const int num_b,
...
/**************************************************************************************
功能描述: boxes_iou_bev_kernel  params boxes_a: (N, 7) [x, y, z, dx, dy, dz, heading]
                               params boxes_b: (M, 7) [x, y, z, dx, dy, dz, heading]
修改记录:
**************************************************************************************/
__global__ void boxes_iou_bev_kernel(const int num_a, const float *boxes_a,
                                    const int num_b, const float *boxes_b, float *ans_iou)
{
    const int a_idx = blockIdx.y * THREADS_PER_BLOCK + threadIdx.y;
    const int b_idx = blockIdx.x * THREADS_PER_BLOCK + threadIdx.x;
...
/**************************************************************************************
功能描述: nms_kernel params: boxes (N, 7) [x, y, z, dx, dy, dz, heading]
...
/**************************************************************************************
功能描述: iou_normal  params: a: [x, y, z, dx, dy, dz, heading]
...
/**************************************************************************************
功能描述: nms_normal_kernel  params: boxes (N, 7) [x, y, z, dx, dy, dz, heading]
                            params: mask (N, N/THREADS_PER_BLOCK_NMS)
修改记录:
**************************************************************************************/
...
NmsCuda::NmsCuda(const int num_threads, const int num_box_corners,const float nms_overlap_threshold)
    : num_threads_(num_threads),num_box_corners_(num_box_corners),
...
修改记录:
**************************************************************************************/
void NmsCuda::DoNmsCuda(const int host_filter_count,float *dev_sorted_box_for_nms, long *out_keep_inds,int *out_num_to_keep)
{
