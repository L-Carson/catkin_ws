...
修改记录:
**************************************************************************************/
unsigned int ROAD_ELE_SHOWER_C::GetSubscriberNum(void) const
{
    return unsigned int(publisher_.getNumSubscribers());
}
...
修改记录:
**************************************************************************************/
void ROAD_ELE_SHOWER_C::ShowLine(unsigned int objId, const std::vector<COORDINATE_2D_STRU> &vectLine, float width, SHOW_COLOR_ENUM enColor)
{
    ...
    unsigned int srcLineSize = vectLine.size();
    unsigned int sampleInterval = srcLineSize / maxShowLineSize_ + 1;
    ST_LOG_INFO_IF(sampleInterval > 1, "Src Line Size : %u, sampleInterval : %u.", srcLineSize, sampleInterval);

    for (unsigned int loop = 0; loop < srcLineSize; loop += sampleInterval)
    {
...
修改记录:
**************************************************************************************/
void ROAD_ELE_SHOWER_C::ShowLabel(unsigned int objId, const COORDINATE_2D_STRU &stPos, const std::string &strLabel, float height, SHOW_COLOR_ENUM enColor)
{
...
修改记录:
**************************************************************************************/
void ROAD_ELE_SHOWER_C::ShowArrow(unsigned int objId, const COORDINATE_2D_STRU &stStartPos, const COORDINATE_2D_STRU &stStopPos, float width, SHOW_COLOR_ENUM enColor)
{
...
修改记录:
**************************************************************************************/
void ROAD_ELE_SHOWER_C::ShowCubeList(unsigned int objId, const std::vector<COORDINATE_2D_STRU> &vectPos, float width, SHOW_COLOR_ENUM enColor)
{
    ...
    for (unsigned int loop = 0; loop < vectPos.size(); ++loop)
    {
...
修改记录:
**************************************************************************************/
void ROAD_ELE_SHOWER_C::Clear(void)
{
...
void ROAD_ELE_SHOWER_C::AddShowObj(const std::string &strNS, unsigned int objId)
{
...
修改记录:
**************************************************************************************/
void ROAD_ELE_SHOWER_C::ClrObjShow(const SHOW_OBJ_STRU &stShowObj) const
{
