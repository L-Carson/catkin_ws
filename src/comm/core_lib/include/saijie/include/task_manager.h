...
#ifndef CORE_NODE_TASK_MANAGER_H
#define CORE_NODE_TASK_MANAGER_H
...
constexpr char kPubTaskModuleTopic[]    = "/alg_to_core_task";///< 算法模块 ---->core模块
constexpr char kSubTaskModuleTopic[]    = "/core_to_alg_task";///< core模块 ---->算法模块
//==================================周期性消息日志打印时长=====================================================================
/** 送任务管理相关消息到人机*/
constexpr int   kDebugTaskManagerSend=5000;
constexpr int   kDebugCallbackCoreManagerSend=5000;
...
public:
     ...
     */
    static BasicTaskManager* Create();
    /**
...
private:
     ...
     * @param[in] signal
     */
    BasicTaskManager(const BasicTaskManager& signal);
    /**
     * 赋值函数
     * @param[in] signal
     * @return
     */
    const BasicTaskManager& operator=(const BasicTaskManager& signal);
private:
    static BasicTaskManager* m_instance_;///< 对象指针
