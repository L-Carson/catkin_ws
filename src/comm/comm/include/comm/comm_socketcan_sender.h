#ifndef __COMM_SOCKETCAN_SENDER_H__
#define __COMM_SOCKETCAN_SENDER_H__
...
修改记录:
**************************************************************************************/
struct SOCKETCAN_SENDER_DBG_INFO_STRU {
    ...
    SOCKETCAN_SENDER_DBG_INFO_STRU(void)
    {
        Clear();
    }
...
修改记录:
**************************************************************************************/
class SOCKETCAN_SENDER_C
{
public:
    SOCKETCAN_SENDER_C(SOCKETCAN_C &objSocketCan, SERIAL_ADDR_ENUM enLocAddr, SERIAL_ADDR_ENUM enPeerAddr, UINT32 maxListSize = SERIAL_SNEDER_MSG_BUFF_SIZE)
                                                        : objSocketCan_(objSocketCan),
